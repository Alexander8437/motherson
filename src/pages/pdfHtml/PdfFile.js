  ...
  return (
    ...
    <div class="pdf" ref={pdfRef}>
      <div class="header pdf-header">
        ...
        <div class="logo">
          <img src={logo} width="100%" alt="motherson-logo" />
        </div>
      </div>
      ...
      <div class="contentQuotation">
        ...
        <div class="quotation">
          <p>
            Curated by
            <br />
            <span class="curated-by">John Deo</span>
          </p>
      ...
      <div class="FaqPdf">
        ...
        <div class="faqQuesMain">
          ...
          <div class="faqQues">
            <h6> When will Demo process OTB?</h6>
            <p>
      ...
      <div class="headerThird">
        ...
        <ul>
          ...
          <li>
            In case your package needs to be cancelled due to any natural calamity, weather conditions etc. Demo shall
            strive to give you the maximum possible refund subject to the agreement made with our trade partners/vendors.
          </li>
          <li>
            If payment is not made as per the schedule provided in the first booking confirmation e-mail, Demo reserves
            the right to cancel the booking after attempting to get in touch with you. Refunds would be as per the package
            cancellation policy.
          </li>
          <li>
            The passenger names in the booking form should be exactly as per passports. Demo will not bear any liability
          ...
          <li>
            ...
            New Year and Christmas or any special occasions. Demo shall try to communicate the same while booking the
            package. However Demo may not have this information readily available all the time.
          </li>
